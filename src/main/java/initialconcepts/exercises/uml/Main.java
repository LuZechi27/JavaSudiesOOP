...
public class Main {
    static void main() {
        ...
        getAndShowFieldedAndOutfieldedPlayers(team);
        System.out.println();

        System.out.println("Realizando substituição (Marcos entra e João sai)");
        team.substitute(p6, p2);
    ...
    static void getAndShowFieldedAndOutfieldedPlayers(Team team) {
